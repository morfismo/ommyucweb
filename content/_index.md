...
{{< callout type="info" >}}
  * **¿Qué grados escolares participan en esta prueba?**
Pueden tomar esta prueba los alumnos de escuelas públicas y particulares que se encuentren en:
* 4º, 5º, 6º de primaria
* 1º, 2º, 3º de secundaria
{{< /callout >}}

### Para escuelas:

{{< callout type="info" >}}
  * **¿Es necesario registrar o inscribir a los alumnos?**

No es necesario registrar o inscribir alumnos previamente a la prueba.
{{< /callout >}}
...
{{< callout type="info" >}}
* **¿Dónde se accede a la prueba?**

Los directores de las escuelas tendrán acceso a la prueba **desde la tarde del viernes 12 de enero** a través del [SIGE (Sistema de Información y Gestión Educativa de Yucatán)](http://www.sigeyucatan.gob.mx/) para su impresión previa al día del examen.
{{< /callout >}}
...
{{< callout type="info" >}}
* **¿Quién califica los exámenes?**
* **¿Cómo acceder a la clave y cómo registrar los alumnos seleccionados?**
...
{{< callout type="info" >}}
* **¿Es necesario subir las copias de los exámenes?**

No, a diferencia de años previos, **no es necesario escanear o subir copias de las pruebas de los alumnos** cuando se registre a los ganadores, únicamente los datos de los alumnos que se piden en el formulario.
{{< /callout >}}
